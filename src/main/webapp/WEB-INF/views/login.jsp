    ...
    <div class="col-md-offset-4 col-md-4" style="margin-top:15px;border:3px solid grey">
        ...
        <form action="/login" METHOD="POST">
            <div class="row">
                ...
                <div class="col-md-8"><input type="text" class="form-control" name="rut" id="rut"
                                             oninput="checkRut(this)" required></div>
            ...
            <div class="row">
                ...
                <div class="col-md-4"><a class="btn btn-default" data-toggle="modal"
                                         data-target="#myModal">Registrarse</a></div>
            </div>
        </form>
        <c:if test="${error}">
            ...
            <form id="registerForm" METHOD="POST" action="/register" onsubmit="validar()">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-8"><input class="form-control" type="rut" name="rut" id="registerRut"
                                                     oninput="checkRut(this)" required></div>
                    </div>

                    <div class="row" style="padding-top: 5px">
                        <div class="col-md-3">Nombre</div>
                        <div class="col-md-8"><input id="registerNombre" class="form-control" name="firstName"
                                                     type="text" required></div>
                    </div>

                    <div class="row" style="padding-top: 5px">
                        <div class="col-md-3">Apellido paterno</div>
                        <div class="col-md-8"><input id="registerApP" class="form-control" name="lastName" type="text"
                                                     required></div>
                    </div>

                    <div class="row" style="padding-top: 5px">
                        <div class="col-md-3">Contraseña</div>
                        <div class="col-md-8"><input class="form-control" id="pass1" name="password" type="password"
                                                     required></div>
                    </div>
                    <div class="row" style="padding-top: 5px">
                        <div class="col-md-3">Repita Contraseña</div>
                        <div class="col-md-8"><input class="form-control" id="pass2" name="passwordConf" type="password"
                                                     required></div>
                    </div>
